    ...
    private void cargarDatos() {
        try {
            ...
            if (ambientes != null && !ambientes.isEmpty()) {
                ...
                System.err.println("   ⚠️ No se encontraron ambientes en la base de datos");
            }
            ...
            if (tiposIncidente != null && !tiposIncidente.isEmpty()) {
                ...
                System.err.println("   ⚠️ No se encontraron tipos de incidente en la base de datos");
            }
            ...
            if (instructores != null && !instructores.isEmpty()) {
                ...
                System.err.println("   ⚠️ No se encontraron instructores en la base de datos");
            }
        } catch (Exception e) {
    ...
    public void init() {
        ...
        if (idIncidenteEditar == null || idIncidenteEditar == 0) {
            try {
                ...
                System.err.println("⚠️ IncidenteBean.init: Error al obtener idIncidenteEditar de URL: " + e.getMessage());
            }
        }
        ...
        // Si hay idIncidenteEditar, cargar el incidente para editar
        if (idIncidenteEditar != null && idIncidenteEditar > 0) {
