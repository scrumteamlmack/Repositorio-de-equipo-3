    ...
    private void cargarUsuarioSiEsEdicion() {
        ...
        if (idUsuarioEditar == null || idUsuarioEditar == 0) {
            try {
                ...
                System.err.println(" UsuarioBean.cargarUsuarioSiEsEdicion: Error al obtener idUsuarioEditar de URL: " + e.getMessage());
            }
        }
        ...
        if (idUsuarioEditar != null && idUsuarioEditar > 0) {
            ...
            if (encontrado != null) {
                ...
                System.err.println("UsuarioBean.cargarUsuarioSiEsEdicion: Usuario no encontrado con ID: " + idUsuarioEditar);
                prepararNuevo();
            }
        } else {
