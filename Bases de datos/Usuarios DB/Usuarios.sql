...
-- Aprendiz roberto sanchez
GRANT SELECT ON mydb.aprendiz TO 'roberto.sanchez'@'localhost';
...
-- Aprendiz laura mendoza
GRANT SELECT ON mydb.aprendiz TO 'laura.mendoza'@'localhost';
GRANT SELECT ON mydb.programas TO 'laura.mendoza'@'localhost';
GRANT SELECT ON mydb.jornada TO 'laura.mendoza'@'localhost';
GRANT SELECT ON mydb.modalidad TO 'laura.mendoza'@'localhost';


-- Aprendiz diego ortega
GRANT SELECT ON mydb.aprendiz TO 'diego.ortega'@'localhost';
GRANT SELECT ON mydb.programas TO 'diego.ortega'@'localhost';
GRANT SELECT ON mydb.jornada TO 'diego.ortega'@'localhost';
GRANT SELECT ON mydb.modalidad TO 'diego.ortega'@'localhost';

-- Aprendiz sandra guerrero
GRANT SELECT ON mydb.aprendiz TO 'sandra.guerrero'@'localhost';
GRANT SELECT ON mydb.programas TO 'sandra.guerrero'@'localhost';
GRANT SELECT ON mydb.jornada TO 'sandra.guerrero'@'localhost';
GRANT SELECT ON mydb.modalidad TO 'sandra.guerrero'@'localhost';

-- Aprendiz andres rojas
...
-- Aprendiz fernando delgado
GRANT SELECT ON mydb.aprendiz TO 'fernando.delgado'@'localhost';
...
-- instructor yolanda arbelaez
GRANT SELECT, INSERT, UPDATE ON mydb.aprendiz TO 'yolanda.arbelaez'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.instructor TO 'yolanda.arbelaez'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.jornada TO 'yolanda.arbelaez'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.registro_asistencia TO 'yolanda.arbelaez'@'localhost';

-- instructor german escobar
GRANT SELECT, INSERT, UPDATE ON mydb.aprendiz TO 'german.escobar'@'localhost';
...
-- instructor alvaro zapata
GRANT SELECT, INSERT, UPDATE ON mydb.aprendiz TO 'alvaro.zapata'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.instructor TO 'alvaro.zapata'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.jornada TO 'alvaro.zapata'@'localhost';
GRANT SELECT, INSERT, UPDATE ON mydb.registro_asistencia TO 'alvaro.zapata'@'localhost';
