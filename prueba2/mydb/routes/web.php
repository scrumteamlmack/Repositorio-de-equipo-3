    ...
    */
    ...
    Route::prefix('instructor')->name('instructor.')->middleware(['auth'])->group(function () {
        ...
        // Aprendices de una ficha específica
        Route::get('/fichas/{id}/aprendices', [InstructorController::class, 'fichaAprendices'])->name('fichaAprendices');
        ...
        // Guarda
     // Perfil del guarda
Route::prefix('guarda')->name('guarda.')->group(function() {
    Route::get('perfil', [App\Http\Controllers\GuardaController::class, 'perfil'])->name('perfil');
    Route::get('perfil/editar', [App\Http\Controllers\GuardaController::class, 'editarPerfil'])->name('editar');
    Route::post('perfil/actualizar', [App\Http\Controllers\GuardaController::class, 'actualizarPerfil'])->name('actualizar');
});

// Opcional: registro de guarda por admin
Route::get('/guarda/create/{id_usuario}', [GuardaController::class, 'create'])->name('create');
Route::post('/guarda/store', [GuardaController::class, 'store'])->name('store');
    ...
    */
    Route::prefix('instructor')->name('instructor.')->group(function () {
        ...
        // Fichas y aprendices
        // Fichas del instructor
    Route::get('/instructor/fichas', [InstructorController::class, 'fichas'])->name('instructor.fichas');

    // Aprendices de una ficha concreta (pasa el id de la ficha)
    Route::get('/instructor/fichas/{id}/fichaAprendices', [InstructorController::class, 'fichaAprendices'])->name('instructor.fichaAprendices');
