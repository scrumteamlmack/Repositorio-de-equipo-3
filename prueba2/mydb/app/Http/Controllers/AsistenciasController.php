  ...
  public function update(Request $request, $id)
{
    ...
    public function misAsistencias($id)
{
    // Ajusta el nombre del campo FK en tu tabla de asistencias
    $asistencias = RegistroInasistencia::where('aprendiz_id', $id)
                  ->with(['ambiente'])
                  ->orderBy('fecha', 'desc')
                  ->get();

    return view('asistencias.index_aprendiz', compact('asistencias'));
}
