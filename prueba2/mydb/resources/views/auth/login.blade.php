...
@endif
   ...
   <form method="POST" action="{{ route('login.submit') }}">
    ...
    <input type="number" id="num_documento" name="num_documento" placeholder="Número de documento" required aria-required="true" />
    
    <label for="pas">Contraseña</label>
    <input type="password" id="contraseña" name="contraseña" placeholder="Contraseña" required aria-required="true" />
